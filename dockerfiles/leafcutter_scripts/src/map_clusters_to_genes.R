...
# write.table(m, file.path(argv$output_dir, argv$output_name, fsep="/"), sep = "\t", quote=FALSE, row.names=FALSE)
# write.table(m, file.path(argv$output_name), sep = "\t", quote=FALSE, row.names=FALSE)
write.table(m, argv$output_name, sep = "\t", quote=FALSE, row.names=FALSE)